...
public abstract class Table<T extends PDPage> {
    ...
    public Table(final float yStart, final float yStartNewPage, final float bottomMargin, final float width, final float margin, final PDDocument document, final T currentPage,
            final boolean drawLines, final boolean drawContent) throws IOException {
    ...
    public Table(final float yStartNewPage, final float bottomMargin, final float width, final float margin, final PDDocument document, final boolean drawLines,
    ...
    protected PDTrueTypeFont loadFont(final String fontPath) throws IOException {
    ...
    public void drawTitle(final String title, final PDFont font, final int fontSize) throws IOException {
        drawTitle(title, font, fontSize, null);
    }

    public void drawTitle(final String title, final PDFont font, final int fontSize, final TextType textType) throws IOException {
    ...
    private void drawCellContent(final Row row) throws IOException {
    ...
    private void drawVerticalLines(final Row row) throws IOException {
        float xStart = margin;
    ...
    private void drawLine(final String type, final float xStart, final float yStart, final float xEnd, final float yEnd) throws IOException {
    ...
    private void fillCellColor(final Cell cell, float yStart, final float xStart, final Iterator<Cell> cellIterator) throws IOException {
        // Fill Cell Color
    ...
    private float getWidth(final Cell cell, final Iterator<Cell> cellIterator) {
        float width;
    ...
    public T getCurrentPage() {
        if (null == this.currentPage) {
            throw new IllegalArgumentException("No current page defined.");
        }
        return this.currentPage;
    }

    public boolean isEndOfPage(final Row row) {
    ...
    private void addBookmark(final PDOutlineItem bookmark) {
        if (bookmarks == null) {
            bookmarks = new ArrayList<PDOutlineItem>();
        }
    ...
    public void setHeader(final Row header) {
        this.header = header;
    }
