...
public final class GeneratePdfTable {
    ...
    public static void preparePdf(final ReportDetails reportDetails) {
        ...
        File file = new File("target/report-sample.pdf");
        try {
            doc.save(file);
            doc.close();
    ...
    public static BaseTable prepareAccountTable(final AccountInfo acctInfo, final PDDocument doc, final PDPage page) {
